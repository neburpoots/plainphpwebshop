...
<body class="vh-100">
    ...
    <div class="row myaccount">
        ...
        <div class="col-sm-8 col-md-9">
                            ...
                            <div class="card-body p-md-5">
                                <div class="row ">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <h1 class=" h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Nieuw product</h1>
                                        <form id="form" method="POST" name='myform' class="mx-1 mx-md-4">
                                            ...
                                            <div class="d-flex  mb-3 mb-lg-4">
                                                <a onclick="validateform()" class="btn btn-primary btn-lg">Maak product</a>
                                            </div>

                                        </form>

                                    </div>
                                    <div class="row col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
            ...
            <script src="./scripts/productcreate.js"></script>
